...
MUSIC
    | Multiple Signal Classification [3]_
    | :py:obj:`pyroomacoustics.doa.music`
NormMUSIC
    | MUSIC with frequency normalization [4]_
    | :py:obj:`pyroomacoustics.doa.normmusic`
CSSM
    | Coherent Signal Subspace Method [5]_
    | :py:obj:`pyroomacoustics.doa.cssm`
WAVES
    | Weighted Average of Signal Subspaces [6]_
    | :py:obj:`pyroomacoustics.doa.waves`
TOPS
    | Test of Orthogonality of Projected Subspaces [7]_
    | :py:obj:`pyroomacoustics.doa.tops`
FRIDA
    | Finite Rate of Innovation Direction of Arrival [8]_
...
.. [4] D. Salvati, C. Drioli, G. L. Foresti, *Incoherent Frequency Fusion for Broadband Steered Response Power Algorithms in
    Noisy Environments*, IEEE Signal Process. Lett., Vol. 21, Num. 5, pp 581-585, 2014

.. [5] H. Wang, M. Kaveh, *Coherent signal-subspace processing for the detection and
...
.. [6] E. D. di Claudio, R. Parisi, *WAVES: Weighted average of signal subspaces for
    robust wideband direction finding*, IEEE Trans. Signal Process., Vol. 49, Num. 10,
    2179--2191, 2001

.. [7] Y. Yeo-Sun, L. M. Kaplan, J. H. McClellan, *TOPS: New DOA estimator for wideband
    signals*, IEEE Trans. Signal Process., Vol. 54, Num 6., pp 1977--1989, 2006

.. [8] H. Pan, R. Scheibler, E. Bezzam, I. Dokmanic, and M. Vetterli, *FRIDA:
